...
export function MeshGradientBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-[#FAFAFA] dark:bg-slate-950">
      ...
      <motion.div
        className="absolute top-0 right-0 w-[80vw] h-[80vh] opacity-20 dark:opacity-40"
        style={{
      ...
      {/* Dark mode gradient layer */}
      <motion.div
        className="absolute bottom-0 left-0 w-[70vw] h-[70vh] opacity-15 dark:opacity-30"
        style={{
          background: "radial-gradient(ellipse at 30% 70%, rgba(236, 72, 153, 0.25) 0%, transparent 60%)",
        }}
        animate={{
          scale: [1, 1.15, 1],
          y: [0, -15, 0],
      ...
      {/* Dark mode gradient layer */}
      <motion.div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[60vh] opacity-10 dark:opacity-20"
        style={{
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#FAFAFA]/80 dark:to-slate-950/80 pointer-events-none" />
    </div>
  );
}
